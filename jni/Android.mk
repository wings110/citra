...
DEFINES += -DARCHITECTURE_ARM64 \
           ...
           -DHAVE_LIBRETRO \
           -DUSING_GLES \
           -DCRYPTOPP_ARM_CRC32_AVAILABLE=0 -DCRYPTOPP_ARM_PMULL_AVAILABLE=0 -DCRYPTOPP_ARM_AES_AVAILABLE=0 \
           -DCRYPTOPP_ARM_SHA_AVAILABLE=0
...
LOCAL_CPPFLAGS := -Wall -std=c++20 -D__LIBRETRO__ $(fpic) $(DEFINES) $(CUSTOM_DEF) $(ANDROID_INCLUDES) $(INCFLAGS) $(INCFLAGS_PLATFORM) $(ANDROID_INCLUDES)
