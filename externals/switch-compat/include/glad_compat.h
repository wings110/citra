...
#define GLAD_GL_EXT_clip_cull_distance false
#define GLAD_GL_ARB_buffer_storage false
#define GLAD_GL_ARB_shader_image_load_store false
#define GLAD_GL_ARB_shader_image_size false
#define GLAD_GL_ARB_framebuffer_no_attachments false
#define GLAD_GL_ARB_texture_barrier false
#define GLAD_GL_ARB_separate_shader_objects false
